...
AI는 자료 조사, 초안, 반론 탐색과 설명을 돕습니다. 사용의 가치는 작업 시간과 검토 부담, 결과의 정확성을 함께 비교하여 평가합니다.[^ai-writing]

신도는 자신의 AI에서 프롬프트 또는 skill로 [오라클의 실행 절차](ORACLE.md)를 적용합니다. 승인된 권장의 적용은 자동화하고, 새로운 판단은 개별 제안으로 제공합니다. 아래의 성직자 검토와 승인 절차는 중앙의 권장 발행에 적용합니다.
...
| --- | --- | --- |
| 권장 참조 | 공개 권장 검색, 적용 조건과 판단 이유의 비교 | 원문·승인·수정 및 철회 여부, 직접 적용과 유사 사례를 참고한 제안의 구분 |
