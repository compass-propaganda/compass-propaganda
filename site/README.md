...
`ORACLE.md`와 `oracle/README.md`는 저장소에서 제공하는 기술 문서로, 사이트의 차례와 HTML 생성 대상에 포함하지 않습니다. 다른 문서의 참조 링크는 저장소 원문으로 연결합니다. 사이트 이용자에게 필요한 자문 방식·웹 접근·갱신 안내는 `setup-oracle.html`에서 간략히 설명합니다.
